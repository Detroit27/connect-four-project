    ...
    <div className={styles.container}>
      <div className={styles.section}>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.toggle}>
            {(['light','dark'] as const).map(th => (
              <button key={th} className={`${styles.toggleBtn} ${theme === th ? styles.active : ''}`}
                onClick={() => setTheme(th)}>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.toggle}>
            {LANGS.map(l => (
              <button key={l.id} className={`${styles.toggleBtn} ${language === l.id ? styles.active : ''}`}
      ...
      <div className={styles.section}>
        ...
        {user ? (
          <div className={styles.accountRow}>
            <div>
              <p className={styles.signedInAs}>{t.config.signedInAs}</p>
              <p className={styles.username}>{profile?.username ?? user.email}</p>
            </div>
